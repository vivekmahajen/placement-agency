        ...
        <div>
          ...
          {isApiKeyError && (
            <p className="text-sm text-red-600 mt-2 font-medium">
              Fix: In Vercel dashboard → Settings → Environment Variables → add <code className="bg-red-100 px-1 rounded">ANTHROPIC_API_KEY</code> with Production checked → then Redeploy.
            </p>
          )}
        </div>
      </div>
